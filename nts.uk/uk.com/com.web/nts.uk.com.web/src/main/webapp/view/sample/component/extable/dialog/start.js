__viewContext.ready(function () {
    ...
    var leftmostColumns2 = [{ key: "workTimeCode", headerText: "コード", width: "60px", handlerType: "input", dataType: "text", ajaxValidate: {
        ...
        { key: "workTimeName", headerText: "就業時間", width: "100px", handlerType: "roundTrip", supplier: function (data, rowIndex, columnKey) {
